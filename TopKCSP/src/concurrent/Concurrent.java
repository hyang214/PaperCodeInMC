...
//		redirect("./results/ADLs/Activity/concurrent/", minGap, maxGap, K, threadNumber, posPath, negPath,turn,a,baseline,"");
		
//		String posPath = "./data/ADLs/Location/A_s.txt";
//		String negPath = "./data/ADLs/Location/B_s.txt";
//		redirect("./results/ADLs/Location/concurrent/", minGap, maxGap, K, threadNumber, posPath, negPath,turn,a,baseline,"");
		
//		String posPath = "./data/genes/eColi/eColi_A.txt";
//		String negPath = "./data/genes/eColi/eColi_B.txt";
//		redirect("./results/genes/eColi/concurrent/", minGap, maxGap, K, threadNumber, posPath, negPath,turn,a,baseline,"");
		
//		String posPath = "./data/bible/old v3.txt";
//		String negPath = "./data/bible/new v3.txt";
//		redirect("./results/bible/bible/concurrent/", minGap, maxGap, K, threadNumber, posPath, negPath,turn,a,baseline,"");

//		String X = " x10";
//		String posPath = "./data/ADLs/ActivityX/A X10.txt";
//		String negPath = "./data/ADLs/ActivityX/B X10.txt";
//		redirect("./results/ADLs/ActivityX/concurrent/", minGap, maxGap, K, threadNumber, posPath, negPath,turn,a,baseline, X);
		
//		String X = " x50";
//		String posPath = "./data/ADLs/LocationX/A_s X50.txt";
//		String negPath = "./data/ADLs/LocationX/B_s X50.txt";
//		redirect("./results/ADLs/LocationX/concurrent/", minGap, maxGap, K, threadNumber, posPath, negPath,turn,a,baseline, X);
		
//		String X = " x50";
//		String posPath = "./data/genes/eColiX/eColi_A X50.txt";
//		String negPath = "./data/genes/eColiX/eColi_B X50.txt";
//		redirect("./results/genes/eColiX/concurrent/", minGap, maxGap, K, threadNumber, posPath, negPath,turn,a,baseline,X);
		
		String X = " x25";
		String posPath = "./data/bible/bibleX/old X25.txt";
		String negPath = "./data/bible/bibleX/new X25.txt";
		redirect("./results/bible/bibleX/concurrent/", minGap, maxGap, K, threadNumber, posPath, negPath,turn,a,baseline,X);
...
//		String negPath = "./data/genes/tatCD/tatCD_B.txt";
	...
	private static void redirect(String path, int minGap, int maxGap, int K, int threadNumber, String posPath, String negPath, boolean turn, boolean a, boolean baseline, String x) {
		...
		try {
			String pathname = "";
			pathname = path+"Concurrent TopK CSP ["+minGap+","+maxGap+"] "+K+" "+ threadNumber +" "+turn+" "+x+" .txt";
