 ...
 */
public class B_AverageTimeCost {
...
//		redirect("./results/att/ADLs/Activity/baseline/ATT "+N+" ", minGap, maxGap, K, posPath, negPath,turn,a,baseline,"");
		
		String posPath = "./data/ADLs/Location/A_s.txt";
		String negPath = "./data/ADLs/Location/B_s.txt";
		redirect("./results/att/ADLs/Location/baseline/ATT "+N+" ", minGap, maxGap, K, posPath, negPath,turn,a,baseline,"");
		
//		String posPath = "./data/genes/eColi/eColi_A.txt";
//		String negPath = "./data/genes/eColi/eColi_B.txt";
//		redirect("./results/att/att/genes/eColi/baseline/ATT "+N+" ", minGap, maxGap, K, posPath, negPath,turn,a,baseline,"");
		
//		String posPath = "./data/bible/old v3.txt";
//		String negPath = "./data/bible/new v3.txt";
//		redirect("./results/att/bible/bible/baseline/ATT "+N+" ", minGap, maxGap, K, posPath, negPath,turn,a,baseline,"");

//		String X = " x10";
//		String posPath = "./data/ADLs/ActivityX/A X10.txt";
//		String negPath = "./data/ADLs/ActivityX/B X10.txt";
//		redirect("./results/att/ADLs/ActivityX/baseline/ATT "+N+" ", minGap, maxGap, K, posPath, negPath,turn,a,baseline,X);
		
//		String X = " x5";
//		String posPath = "./data/ADLs/LocationX/A_s X5.txt";
//		String negPath = "./data/ADLs/LocationX/B_s X5.txt";
//		redirect("./results/att/ADLs/LocationX/baseline/ATT "+N+" ", minGap, maxGap, K, posPath, negPath,turn,a,baseline,X);
		
//		String X = " x10";
//		String posPath = "./data/genes/eColiX/eColi_A X10.txt";
//		String negPath = "./data/genes/eColiX/eColi_B X10.txt";
//		redirect("./results/att/genes/eColiX/baseline/ATT "+N+" ", minGap, maxGap, K, posPath, negPath,turn,a,baseline,X);
