...
public class Baseline {
	...
	public Baseline(int minGap, int maxGap, int K, String posPath, String negPath, boolean a, boolean baseline) {
		this.minGap = minGap;
		this.maxGap = maxGap;
		this.K = K;
		try {
...
//		print(negMap);
		...
		BGenerateCandidatePattern gcp = new BGenerateCandidatePattern(posMap, negMap, K, minGap, maxGap, pos.size(), neg.size(), baseline);
		gcp.genCP();
