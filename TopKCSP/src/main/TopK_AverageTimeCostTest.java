 ...
 */
public class TopK_AverageTimeCostTest {
...
//		redirect("./results/att/ADLs/Activity/top-k csp/ATT "+N+" ", minGap, maxGap, K, posPath, negPath,turn,a,baseline,"");
		
//		String posPath = "./data/ADLs/Location/A_s.txt";
//		String negPath = "./data/ADLs/Location/B_s.txt";
//		redirect("./results/att/ADLs/Location/top-k csp/ATT "+N+" ", minGap, maxGap, K, posPath, negPath,turn,a,baseline,"");
		
		String posPath = "./data/genes/eColi/eColi_A.txt";
		String negPath = "./data/genes/eColi/eColi_B.txt";
		redirect("./results/att/genes/eColi/top-k csp/ATT "+N+" ", minGap, maxGap, K, posPath, negPath,turn,a,baseline,"");
		
//		String posPath = "./data/bible/old v3.txt";
//		String negPath = "./data/bible/new v3.txt";
//		redirect("./results/att/bible/bible/top-k csp/ATT "+N+" ", minGap, maxGap, K, posPath, negPath,turn,a,baseline,"");

//		String X = " x5";
//		String posPath = "./data/ADLs/ActivityX/A X5.txt";
//		String negPath = "./data/ADLs/ActivityX/B X5.txt";
//		redirect("./results/att/ADLs/ActivityX/top-k csp/ATT "+N+" ", minGap, maxGap, K, posPath, negPath,turn,a,baseline,X);
		
//		String X = " x20";
//		String posPath = "./data/ADLs/LocationX/A_s X20.txt";
//		String negPath = "./data/ADLs/LocationX/B_s X20.txt";
//		redirect("./results/att/ADLs/LocationX/top-k csp/ATT "+N+" ", minGap, maxGap, K, posPath, negPath,turn,a,baseline,X);
		
//		String X = " x20";
//		String posPath = "./data/genes/eColiX/eColi_A X20.txt";
//		String negPath = "./data/genes/eColiX/eColi_B X20.txt";
//		redirect("./results/att/genes/eColiX/top-k csp/ATT "+N+" ", minGap, maxGap, K, posPath, negPath,turn,a,baseline,X);
		
//		String X = " x5";
//		String posPath = "./data/bible/bibleX/old X5.txt";
//		String negPath = "./data/bible/bibleX/new X5.txt";
//		redirect("./results/att/bible/bibleX/top-k csp/ATT "+N+" ", minGap, maxGap, K, posPath, negPath,turn,a,baseline,X);
